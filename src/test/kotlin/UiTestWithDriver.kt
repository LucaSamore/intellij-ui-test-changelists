...
class UiTestWithDriver {
    ...
    /**
     * Opens the editor from the project view, navigates to a specific line in the editor, and
     * inserts a comment line at the caret position.
     *
     * @param splitMode Determines the mode of execution. If true, the test runs on a remote
     *   development environment with IDE backend and frontend running on the same host.
     */
            ...
            ideFrame {
                ...
                codeEditor().apply {
                    ...
                    assertTrue(text.contains("Hello!")) {
                        "Editor doesn't contain the entered text"
                    }
                }
            }
        }
